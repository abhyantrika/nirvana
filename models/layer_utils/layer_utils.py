...
# 	def __init__(self,dim,num_timesteps,freq):
# 		super().__init__()
...
class PositionalEncoding_time(nn.Module):
	def __init__(self, dim, num_timesteps,cfg,freq=100.0):
		super(PositionalEncoding_time, self).__init__()
		self.D = dim
	...
	def forward(self, indices):
		...
		positional_encodings = self.weight[indices, :]
